...
// arModel is a active record design model for table article_tags operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of article_tags.
	Table = "article_tags"
	// Model is the model object of article_tags.
