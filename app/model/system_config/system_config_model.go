...
// arModel is a active record design model for table system_config operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of system_config.
	Table = "system_config"
	// Model is the model object of system_config.
