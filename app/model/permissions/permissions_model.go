...
// arModel is a active record design model for table permissions operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of permissions.
	Table = "permissions"
	// Model is the model object of permissions.
