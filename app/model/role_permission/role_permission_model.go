...
// arModel is a active record design model for table role_permission operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of role_permission.
	Table = "role_permission"
	// Model is the model object of role_permission.
