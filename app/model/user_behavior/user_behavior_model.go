...
// arModel is a active record design model for table user_behavior operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of user_behavior.
	Table = "user_behavior"
	// Model is the model object of user_behavior.
