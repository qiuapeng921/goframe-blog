...
// arModel is a active record design model for table user_friend operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of user_friend.
	Table = "user_friend"
	// Model is the model object of user_friend.
