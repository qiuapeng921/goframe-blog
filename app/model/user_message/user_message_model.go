...
// arModel is a active record design model for table user_message operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of user_message.
	Table = "user_message"
	// Model is the model object of user_message.
