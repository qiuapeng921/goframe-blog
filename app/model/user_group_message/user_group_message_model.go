...
// arModel is a active record design model for table user_group_message operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of user_group_message.
	Table = "user_group_message"
	// Model is the model object of user_group_message.
