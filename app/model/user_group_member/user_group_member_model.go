...
// arModel is a active record design model for table user_group_member operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of user_group_member.
	Table = "user_group_member"
	// Model is the model object of user_group_member.
